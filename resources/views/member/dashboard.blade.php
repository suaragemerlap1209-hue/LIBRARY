    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="{{ route('member.loans.index') }}" class="text-xs font-semibold text-gray-400 hover:text-gray-600 flex items-center gap-1">
                    LIHAT SEMUA
            ...
            <div class="space-y-4">
                @foreach ($loans as $loan)
                    <div class="bg-white rounded-2xl border {{ $loan['status'] === 'terlambat' ? 'border-red-200 border-l-4 border-l-red-400' : 'border-[#ECE7DC]' }} p-4 flex items-center gap-4">
                        ...
                        <a href="{{ route('member.loans.index') }}" class="w-9 h-9 rounded-full border {{ $loan['status'] === 'terlambat' ? 'bg-red-500 border-red-500 text-white' : 'border-gray-200 text-gray-400' }} flex items-center justify-center shrink-0 hover:opacity-80 transition">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border border-[#ECE7DC] rounded-2xl p-5">
                ...
                <a href="{{ route('member.catalog.index') }}" class="block text-center border border-[#ECE7DC] rounded-xl py-2.5 text-xs font-semibold tracking-wide text-gray-600 hover:bg-gray-50">
                    JELAJAHI KATALOG
                </a>
            </div>
        </div>
