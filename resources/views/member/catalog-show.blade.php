...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl border border-stone-100 shadow-sm p-8">
            ...
            <p class="text-stone-500 mb-1">oleh {{ $book->author }}</p>
            @if ($book->category)
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 mb-8">
                ...
                @endif
                <div>
                    <p class="text-xs text-stone-400 uppercase tracking-wide">Buku Tersedia</p>
                    <p class="text-sm font-medium text-stone-800">{{ $book->available_copies }}</p>
                </div>
                <div>
                    <p class="text-xs text-stone-400 uppercase tracking-wide">Masa Pinjam</p>
                    <p class="text-sm font-medium text-stone-800">31 Hari</p>
                </div>
            </div>
