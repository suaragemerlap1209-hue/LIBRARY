...
<div class="lg:col-span-2 bg-white rounded-2xl border border-black/5 overflow-hidden">
    <div class="px-6 py-4 border-b border-black/5 flex items-center justify-between">
        <div>
            <h3 class="text-sm font-semibold text-[#1F2937]">Permintaan Peminjaman</h3>
            <p class="text-xs text-[#9CA3AF]">Peminjaman baru yang menunggu persetujuan.</p>
        </div>
        <a href="{{ Route::has('admin.loans.index') ? route('admin.loans.index') : '#' }}"
